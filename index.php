...
<div id="primary" class="content-area">
    ...
    $obj=get_page_by_title( $pagename, $output = OBJECT, $post_type = 'page' );
     $args = array ( 'post_parent'=>268, // Allows users to set order of subpages //Enter code to display for each subpage here. For example, list items // containing featured thumbnails, page titles and permalinks to // the pages. 
                        'order' => 'DESC',
                        'posts_per_page' => 3,
						'post_parent' => $obj->ID,
						'post_type' => 'page',
    ...
    $obj=get_page_by_title( $pagename, $output = OBJECT, $post_type = 'page' );
     $args = array ( 'post_parent'=>129, // Allows users to set order of subpages //Enter code to display for each subpage here. For example, list items // containing featured thumbnails, page titles and permalinks to // the pages. 
                        'order' => 'DESC',
                        'posts_per_page' => 3,
						'post_parent' => $obj->ID,
						'post_type' => 'page',
					...
					<div id="Tokyo" class="col-md-9 tabcontent">
					  <?php
						...
						$obj=get_page_by_title( $pagename, $output = OBJECT, $post_type = 'page' );
						$args = array ( 'post_parent' =>140 , // Allows users to set order of subpages //Enter code to display for each subpage here. For example, list items // containing featured thumbnails, page titles and permalinks to // the pages. 
                        'order' => 'DESC',
                        'posts_per_page' => 3,
						'post_parent' => $obj->ID,
						'post_type' => 'page',
